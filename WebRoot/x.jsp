  ...
  <div id="main-content">
    ...
    <section id="contact" class="clearfix">
      ...
      <form action="#" method="post">
        ...
        <p><textarea cols="20" rows="7" name="content" id="message" onblur="if (this.value == ''){this.value = 'Your Message'; }" onfocus="if (this.value == 'Your Message') {this.value = '';}" >Your Message</textarea></p>
