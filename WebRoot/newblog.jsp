		...
		<aside id="sidebar">
			<nav>
				...
				<ul>
					...
					<li class="active" id="nav-3"><a href="showSave.action">新建博文</a>
					</li>
		...
		<div id="main-content">
			...
			<div class="wrapper" >
				<article>
					...
					<form action="saveBlog.action" method="post">
						<label for="name">Title:</label> <br> <input type="text"
							name="title" id="name" value="" tabindex="1" /> <br> <br>
