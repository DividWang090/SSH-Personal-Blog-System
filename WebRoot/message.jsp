<!DOCTYPE html>
<%@ page language="java" import="java.util.*,com.dao.*,com.domain.*"
	pageEncoding="utf-8"%>
...
#list ul li:nth-child(even) a {
	position: relative;
	top: 0;
	background: #cfc;
}

#list ul li:nth-child(3n) a {
	position: relative;
	top: 0;
	background: #ccf;
}

#list ul li:nth-child(5n) a {
	position: relative;
	top: 0;
}

#list ul li a:hover,ul li a:focus {
		...
		<aside id="sidebar">
			<nav>
				...
				<ul>
					...
					<li class="active" id="nav-2"><a href="viewMessage.action">留言板</a>
					</li>
					<li id="nav-3"><a href="showSave.action">新建博文</a></li>
					
					<li id="nav-4"><a href="manager.action">后台管理</a>
					<li id="nav-5"><a href="getInformation.action">信息统计</a>
		...
		<div id="main-content">
			...
			<div class="wrapper" align="center">
				<article>
					...
					<h3 align="center">Create A New Message</h3>
					<form action="saveMessage.action" method="post">
						<label for="name">Your Name:</label>  <input type="text"
							name="name" id="name" value="" tabindex="1" /> <br> <br>
						<label for="textarea">Content:</label> <br>
						<textarea cols="40" rows="8" name="content" id="textarea"></textarea>
				...
				<ul>
					<%
						...
						while (it.hasNext()) {
							...
							out.print("<li><a><h2 font-size:25px>" + message.getName()
									+ "</h2><p font-size:25px>" + message.getContent()
									+ "</p></a></li>");
						}
					%>
				</ul>
