		...
		<aside id="sidebar">
			<nav>
				<a class="logo" href="#top" id="nav-logo"><span>Arith Xu</span>Arith's
					Blog</a>
				<ul>
					<li class="active" id="nav-1"><a href="viewBlog.action">博客</a>
					</li>
					<li id="nav-2"><a href="viewMessage.action">留言板</a></li>
			...
			<div>
				...
				<div class="recent-work columns">
					...
					<div class="two-column">
						<figure>
							<a href="images/pricing_table_3.jpg" rel="recent_work"
								class="zoom"><img src="images/work_1.jpg" alt="Image">
							</a>
						</figure>
					</div>
					<div class="two-column last">
						<figure>
							<a href="images/pricing_table_3.jpg" rel="recent_work"
								class="zoom"><img src="images/work_2.jpg" alt="Image">
							</a>
						</figure>
					</div>
				</div>
				...
				<div class="my-services columns">
					...
					<div class="three-column">
						<h4>Web Design</h4>
						<p>This is just a place holder for people who need type to
				...
				<div class="one-column columns testimony">
					<div class="clearfix says">
						<%
							...
							while (it.hasNext()) {
								blog = (Blog) it.next();
								out.print("<blockquote><h3>" + blog.getTitle() + "</h3><p>"
										+ blog.getContent() + "<hr/></p></blockquote>");
							}
						%>
